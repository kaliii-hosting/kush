...
const SpotifyPlayerBar = () => {
  ...
  return (
    <>
      <div className="bg-gray-darkest border-t border-border px-2 sm:px-4 py-2 sm:py-3 flex items-center justify-between fixed bottom-0 left-0 right-0 z-50">
          ...
          <>
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gray-dark rounded-md overflow-hidden flex-shrink-0">
              {currentTrack.coverUrl || currentTrack.thumbnail || currentTrack.albumArt ? (
                <img 
                  src={currentTrack.coverUrl || currentTrack.thumbnail || currentTrack.albumArt} 
    ...
    {/* Queue Panel */}
    {showQueue && (
      <div className="fixed bottom-24 right-4 bg-gray-darkest border border-border rounded-lg p-4 w-80 max-h-96 overflow-y-auto z-50 shadow-xl">
              ...
              >
                <div className="w-10 h-10 bg-gray-dark rounded overflow-hidden flex-shrink-0">
                  {track.coverUrl || track.thumbnail || track.albumArt ? (
                    <img 
                      src={track.coverUrl || track.thumbnail || track.albumArt} 
                      alt={track.title}
                      className="w-full h-full object-cover"
                    />
                  ) : (
