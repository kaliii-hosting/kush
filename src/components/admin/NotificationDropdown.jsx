    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {showDropdown && (
        <>
          ...
          {/* Desktop Dropdown */}
          <div className="hidden md:block absolute right-0 mt-2 w-72 bg-[#181818] rounded-lg shadow-2xl border border-[#282828] z-50">
          {/* Header */}
              ...
              {notifications.length > 0 && (
                <div className="flex items-center gap-2">
                  {unreadCount > 0 && (
                    <button
                      onClick={markAllAsRead}
                      className="p-1.5 text-[#b3b3b3] hover:text-white hover:bg-[#282828] rounded-full transition-all"
                      title="Mark all as read"
                    >
                      <CheckCheck className="w-4 h-4" />
                    </button>
