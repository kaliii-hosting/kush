...
const NotificationSystem = () => {
  ...
  return (
    <>
      ...
      {/* Notification Popup */}
      {showPopup && (
        <div className="absolute right-0 top-full mt-2 w-96 max-w-[calc(100vw-2rem)] lg:max-w-96 bg-[#282828] rounded-lg shadow-xl border border-[#404040] max-h-[500px] overflow-hidden z-[9999] animate-slideIn" style={{
          position: 'absolute',
          right: '0',
          top: '100%',
          marginTop: '8px',
