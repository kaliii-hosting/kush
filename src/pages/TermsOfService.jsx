  ...
  const sections = [
    {
      ...
      content: `Welcome to Kushie Brand. These Terms of Service ("Terms") govern your use of our website, products, and services. By accessing or using our website, you agree to be bound by these Terms.
...
You are responsible for safeguarding your password and may not disclose it to any third party. You agree to immediately notify us of any unauthorized use of your account.`
    },
    {
      ...
      subtitle: "Cannabis Products",
      content: `All cannabis products sold on our website are subject to state and local laws and regulations. By purchasing our products, you agree to:

• Comply with all applicable laws regarding the purchase, possession, and use of cannabis products
...
All sales are final unless otherwise stated. Prices are subject to change without notice. We are not responsible for pricing, typographical, or other errors in any offer.`
    },
    {
      ...
      content: `Shipping is available only to locations where cannabis products are legal. You are responsible for ensuring that receiving our products is legal in your jurisdiction.
...
You agree to inspect products upon delivery and report any issues within 48 hours. Failure to report issues within this timeframe constitutes acceptance of the products.`
    },
    {
      ...
      content: `All content on this website, including text, graphics, logos, images, audio clips, digital downloads, and software, is the property of Kushie Brand or its content suppliers and is protected by intellectual property laws.
...
You use our website and services at your own risk.`
    },
    {
      ...
      subtitle: "Damages",
      content: `To the fullest extent permitted by law, Kushie Brand and its affiliates, officers, directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:
...
Some jurisdictions do not allow the exclusion of certain warranties or limitations of liability, so some of these limitations may not apply to you.`
    },
    {
      ...
      content: `You agree to indemnify, defend, and hold harmless Kushie Brand, its affiliates, and their respective officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses, including reasonable attorney's fees, arising out of or in any way connected with:
...
All notices to Kushie Brand must be sent to the above address or email.`
    }
  ];
